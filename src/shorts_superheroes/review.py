    ...
    for story in stories:
        lines.extend(
            [
                ...
                f"**Moral:** {story.moral}",
                "",
                f"**Villain:** {story.villain_profile.name or 'Not provided'}",
                "",
                f"**Villain motive:** {story.villain_profile.motive or 'Not provided'}",
                "",
                f"**Villain plan:** {story.villain_profile.plan or 'Not provided'}",
                "",
                "**Script:**",
                "",
                story.script,
